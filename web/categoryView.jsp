            ...
            <div class="container">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">${requestScope.category.getCategoryName()}</li>
                    </ol>
                </nav>
            </div> <!-- container.// -->
                                ...
                                <article class="filter-group">
                                    ...
                                    <div class="filter-content collapse show" id="collapse_1">
                                        <div class="card-body pt-0">
                                            <input type="hidden" name="id" value="${requestScope.category}">
                                            <c:choose>
                    ...
                    <main class="col-md-8 col-lg-9">
                        ...
                        <header class="border-bottom mb-4 pb-3">
                            <div class="form-inline d-flex justify-content-between align-items-center">
                                <span>${requestScope.count_cate} sản phẩm</span>
                            </div>
                        </header> <!-- sect-heading -->
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="card p-3 mb-4">
                                        ...
                                        <figcaption class="info-wrap mt-2">
                                            <a href="${pageContext.request.contextPath}/detailbook?id=${product.getBookID()}"
                                               class="title">${product.getTitle()}</a>
                                            <div>
